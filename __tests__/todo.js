...
describe("Test case for database", () => {
  ...
  test("Sign Up", async () => {
    ...
    const response = await agent.post("/users").send({
      firstName: "Mahesh",
      lastName: "mangalapelli",
      email: "mangalapellimahesh@gmail.com",
      password: "Mahesh",
      _csrf: csrfToken,
    });
  ...
  test("Creates a todo", async () => {
    ...
    await login(agent, "mangalapellimahesh@gmail.com", "Mahesh");
    var res = await agent.get("/todos");
    var csrfToken = getCsrfToken(res);
  ...
  test("userA cannot update userB's todo", async () => {
    ...
    await agent.post("/users").send({
      firstName: "Mahes",
      lastName: "mangalapell",
      email: "mangalapellimahes@gmail.com",
      password: "Mahes",
      _csrf: csrfToken,
    });
  ...
  test("userA cannot delete userB's todo", async () => {
    ...
    await login(agent, "mangalapellimahes@gmail.com", "Mahes");
